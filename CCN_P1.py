...
def calculate_time2(start, stop):
   
    # Calculate time internet was used for
    usage = start - stop
    seconds = float(str(usage.total_seconds()))
    return str(datetime.timedelta(seconds=seconds)).split(".")[0] # Converting to seconds
...
def main():
    ...
    while True:
        ...
        if ping():
            ...
            x = calculate_time2(monitoring_date_time, down_time)
